            ...
            if let data = data {
                do {
                    ...
                    for dto in groupsData {
                        groups.append(dto.createGroupFromDTO())
                    }
                ...
                if let data = data {
                    do {
                        ...
                        if let image = image {
                            ...
                            let recievedGroup = dataGroup.createGroupFromDTO()
            ...
            if let data = data {
                do {
                    ...
                    for dto in meetingData {
                        meetings.append(dto.createMeetingFromDTO())
                    }
        ...
        let task = session.dataTask(with: request, completionHandler: ({ data, responce, error in
            ...
            if let data = data {
                do {
                    ...
                    let recievedGroup = dataMeeting.createGroupFromDTO()
                    DispatchQueue.main.async { completion(recievedGroup, nil) }
                } catch let error {
                    DispatchQueue.main.async { completion(nil, error) }
                }
            ...
            if let data = data {
                do {
                    ...
                    for group in groupData["my"]! {
                        groups.append(group.createGroupFromDTO())
                    }
