...
#ifndef MESSAGEKIT_SWIFT_H
#define MESSAGEKIT_SWIFT_H
...
SWIFT_CLASS("_TtC10MessageKit22LinkPreviewMessageCell")
@interface LinkPreviewMessageCell : TextMessageCell
- (void)applyLayoutAttributes:(UICollectionViewLayoutAttributes * _Nonnull)layoutAttributes;
- (void)prepareForReuse;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC10MessageKit15LinkPreviewView")
@interface LinkPreviewView : UIView
...
@interface MessagesViewController : UIViewController <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, UIGestureRecognizerDelegate>
...
@interface MessagesViewController (SWIFT_EXTENSION(MessageKit)) <UIScrollViewDelegate>
